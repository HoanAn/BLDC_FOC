...
int Back_Emf_detect(int Phase_A_Volt, int Phase_B_Volt, int Phase_C_Volt, int Virtual_Ground_Volt, int DC_Bus, int Step, uint8_t Start_up);// rreturn commutation moment.
//////////////////////	 
